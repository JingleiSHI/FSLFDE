...
class CorrelationKernel : public OpKernel {
  public:
    ...
    void Compute(OpKernelContext *ctx) override {
      ...
      // Allocate the memory for the output  // SHI:  Status OpKernelContext::allocate_output(int index, const TensorShape& shape, Tensor** output)
      Tensor *output_t;
...
// SHI: define the operating system is GPU
